...
void main_cvirtos(void)
{
	...
	printf("Hello World - final build\n");

	debug_printf("Hello Debug printf");
	...
	xTaskCreate(health, "health", configMINIMAL_STACK_SIZE, NULL, 2, NULL);
